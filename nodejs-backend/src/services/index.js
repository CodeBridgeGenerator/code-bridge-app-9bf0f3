...
const trainingProvidersDescription = require("./trainingProvidersDescription/trainingProvidersDescription.service.js");
...
module.exports = function (app) {
  ...
  app.configure(trainingProvidersDescription);
