...
import TrainingProvidersDescriptionPage from "../TrainingProvidersDescriptionPage/TrainingProvidersDescriptionPage";
...
case "trainingProvidersDescription":
                return <TrainingProvidersDescriptionPage />;
case "trainerDetails":
...
<li
                onClick={() => {
                  setCurrentActiveTab2("trainingProvidersDescription");
                }}
                className={classNames("mb-3 flex align-items-start p-3", {
                  "bg-yellow-700": props?.currentActiveTab2 === "trainingProvidersDescription",
                })}
                style={{ borderRadius: "12px" }}
              >
                <i
                  className="pi pi-user text-xl mr-3 "
                  style={{ color: props?.currentActiveTab2 !== "trainingProvidersDescription" ? "black" : "white" }}
                ></i>
                <div className="flex flex-column">
                  <span
                    className={classNames({
                      "text-white": props?.currentActiveTab2 === "trainingProvidersDescription",
                      "text-black": props?.currentActiveTab2 !== "trainingProvidersDescription",
                    })}
                  >
                  Training Providers Description
                  </span>
                  <p
                    className={classNames("mt-2 mb-0 line-height-3 ", {
                      "text-yellow-500": props?.currentActiveTab2 === "trainingProvidersDescription",
                      "text-yellow-700": props?.currentActiveTab2 !== "trainingProvidersDescription",
                    })}
                  >
                    Accumsan sit amet nulla facilisi morbi tempus iaculis.
                  </p>
