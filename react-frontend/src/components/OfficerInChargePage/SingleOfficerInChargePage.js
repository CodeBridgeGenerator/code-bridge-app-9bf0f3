...
const SingleOfficerInChargePage = (props) => {
    ...
    return (
        ...
        <div className="col-12 flex flex-column align-items-center">
            ...
            <div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-primary">Officer Name</label><p className="m-0 ml-3" >{_entity?.officerName}</p></div>
...
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-primary">Hp.</label><p className="m-0 ml-3" >{Number(_entity?.hp)}</p></div>
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-primary">IC / Passport Number</label><p className="m-0 ml-3" >{_entity?.icPassportNumber}</p></div>
